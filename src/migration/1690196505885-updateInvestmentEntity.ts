...
export class UpdateInvestmentEntity1690196505885 implements MigrationInterface {
  name = 'UpdateInvestmentEntity1690196505885';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loan" RENAME COLUMN "final_payment_date" TO "next_payment_date"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loan" RENAME COLUMN "next_payment_date" TO "final_payment_date"`,
    );
    await queryRunner.query(
